...
const img_2="../img/avion_2.png" 
  ...
  <div>
    ...
    <marquee  width="50%" scrolldelay="1" scrollamount="5" direction="left" loop="infinite"> <p className='display-3 fw-bold fst-italic'>🎇  Find the perfect destination   🎇</p></marquee>
